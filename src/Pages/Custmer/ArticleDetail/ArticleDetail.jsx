...
const ArticleDetail = () => {
  ...
  const { heading, createdAt, readTime, category, reportDescription, image , id} = useParams();
  // alert(createdAt)
    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-10">
        ...
        <div className="col-span-8 lg:col-span-8 p-8 pt-0">
          <div className="flex items-center justify-end border-b-2 py-8">

            <div className="flex items-center justify-between">
              <img src="/savegreen.png" className='cursor-pointer' alt="" onClick={handleSaveArticle} />
              <p className="ms-2 cursor-pointer" onClick={handleSaveArticle}>Save</p>
            </div>
          </div>
          <div>
